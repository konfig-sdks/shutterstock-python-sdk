...
class LicenseVideoResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["video_id", "allotment_charge", "download", "error", "license_id", "price", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["video_id", "allotment_charge", "download", "error", "license_id", "price", ], str]):
