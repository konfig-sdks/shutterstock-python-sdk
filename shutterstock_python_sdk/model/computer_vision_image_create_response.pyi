...
class ComputerVisionImageCreateResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["upload_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["upload_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        upload_id: typing.Union[MetaOapg.properties.upload_id, str, ],
