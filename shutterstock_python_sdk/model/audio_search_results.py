...
class AudioSearchResults(
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Audio']:
                        return Audio
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Audio'], typing.List['Audio']],
                ...
                def __getitem__(self, i: int) -> 'Audio':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "search_id", "total_count", "message", "page", "per_page", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "search_id", "total_count", "message", "page", "per_page", ], str]):
