...
class DescriptorsListResult(
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Descriptors']:
                        return Descriptors
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Descriptors'], typing.List['Descriptors']],
                ...
                def __getitem__(self, i: int) -> 'Descriptors':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "page", "per_page", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "page", "per_page", ], str]):
