...
from shutterstock_python_sdk.pydantic.featured_collection import FeaturedCollection

class FeaturedCollectionDataList(BaseModel):
    # Featured collections
    data: typing.Optional[typing.List[FeaturedCollection]] = Field(None, alias='data')
