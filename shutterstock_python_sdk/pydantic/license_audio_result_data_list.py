...
from shutterstock_python_sdk.pydantic.license_audio_result import LicenseAudioResult

class LicenseAudioResultDataList(BaseModel):
    # License results
    data: typing.Optional[typing.List[LicenseAudioResult]] = Field(None, alias='data')
