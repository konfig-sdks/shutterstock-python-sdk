...
from shutterstock_python_sdk.pydantic.license_video_result import LicenseVideoResult

class LicenseVideoResultDataList(BaseModel):
    # License results
    data: typing.Optional[typing.List[LicenseVideoResult]] = Field(None, alias='data')
