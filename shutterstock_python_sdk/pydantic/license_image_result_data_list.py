...
from shutterstock_python_sdk.pydantic.license_image_result import LicenseImageResult

class LicenseImageResultDataList(BaseModel):
    # License results
    data: typing.Optional[typing.List[LicenseImageResult]] = Field(None, alias='data')
