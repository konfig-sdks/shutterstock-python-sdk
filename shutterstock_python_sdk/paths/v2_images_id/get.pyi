...
from shutterstock_python_sdk.model.image import Image as ImageSchema
...
from shutterstock_python_sdk.pydantic.image import Image as ImagePydantic
...
SchemaFor200ResponseBodyApplicationJson = ImageSchema
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        **kwargs,
        ...
        if validate:
            return ImagePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImagePydantic, raw_response.body)
