...
class BaseApi(api_client.Api):
    ...
    def _get_collection_items_0_mapped_args(
        self,
        id: str,
    ...
    async def _aget_collection_items_0_oapg(
        self,
    ...
    def _get_collection_items_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCollectionItems0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_collection_items_0(
        self,
        id: str,
        page: typing.Optional[int] = None,
        per_page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_collection_items_0_mapped_args(
            id=id,
            page=page,
            per_page=per_page,
        ...
        return await self._aget_collection_items_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_collection_items_0(
        self,
        id: str,
        page: typing.Optional[int] = None,
        per_page: typing.Optional[int] = None,
        ...
        return self._get_collection_items_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCollectionItems0(BaseApi):
    ...
    async def aget_collection_items_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_collection_items_0(
            id=id,
            page=page,
            per_page=per_page,
            share_code=share_code,
    ...
    def get_collection_items_0(
        ...
        raw_response = self.raw.get_collection_items_0(
            id=id,
            page=page,
            per_page=per_page,
            share_code=share_code,
