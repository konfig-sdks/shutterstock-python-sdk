...
from shutterstock_python_sdk.model.editorial_search_results import EditorialSearchResults as EditorialSearchResultsSchema

from shutterstock_python_sdk.type.editorial_search_results import EditorialSearchResults

from ...api_client import Dictionary
from shutterstock_python_sdk.pydantic.editorial_search_results import EditorialSearchResults as EditorialSearchResultsPydantic
...
SchemaFor200ResponseBodyApplicationJson = EditorialSearchResultsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EditorialSearchResults
...
class BaseApi(api_client.Api):
    ...
    def _search_content_mapped_args(
        self,
        country: str,
    ...
    async def _asearch_content_oapg(
        self,
...
class SearchContentRaw(BaseApi):
    ...
    async def asearch_content(
        ...
        **kwargs,
        ...
        args = self._search_content_mapped_args(
            country=country,
            query=query,
            sort=sort,
            category=category,
        ...
        return await self._asearch_content_oapg(
    ...
    def search_content(
        ...
        return self._search_content_oapg(
            query_params=args.query,
        )

class SearchContent(BaseApi):
    ...
    async def asearch_content(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EditorialSearchResultsPydantic:
        raw_response = await self.raw.asearch_content(
            country=country,
            query=query,
            sort=sort,
            category=category,
        ...
        if validate:
            return EditorialSearchResultsPydantic(**raw_response.body)
        return api_client.construct_model_instance(EditorialSearchResultsPydantic, raw_response.body)
    ...
    def search_content(
        ...
        raw_response = self.raw.search_content(
            country=country,
            query=query,
            sort=sort,
            category=category,
