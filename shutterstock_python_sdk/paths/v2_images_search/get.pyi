...
from shutterstock_python_sdk.model.image_search_results import ImageSearchResults as ImageSearchResultsSchema
...
from shutterstock_python_sdk.pydantic.image_search_results import ImageSearchResults as ImageSearchResultsPydantic
...
class AspectRatioSchema(
    ...
    pass
AiSearchSchema = schemas.BoolSchema


class AiLabelsLimitSchema(
    schemas.IntSchema
):
    pass


class AiIndustrySchema(
    schemas.EnumBase,
    schemas.StrSchema
):
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'ai_search': typing.Union[AiSearchSchema, bool, ],
        'ai_labels_limit': typing.Union[AiLabelsLimitSchema, decimal.Decimal, int, ],
        'ai_industry': typing.Union[AiIndustrySchema, str, ],
        'ai_objective': typing.Union[AiObjectiveSchema, str, ],
...
request_query_ai_search = api_client.QueryParameter(
    name="ai_search",
    style=api_client.ParameterStyle.FORM,
    schema=AiSearchSchema,
    explode=True,
)
request_query_ai_labels_limit = api_client.QueryParameter(
    name="ai_labels_limit",
    style=api_client.ParameterStyle.FORM,
    schema=AiLabelsLimitSchema,
    explode=True,
)
request_query_ai_industry = api_client.QueryParameter(
    name="ai_industry",
    style=api_client.ParameterStyle.FORM,
    schema=AiIndustrySchema,
    explode=True,
)
request_query_ai_objective = api_client.QueryParameter(
    name="ai_objective",
    style=api_client.ParameterStyle.FORM,
    schema=AiObjectiveSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ImageSearchResultsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ImageSearchResults
...
class BaseApi(api_client.Api):
    ...
    def _search_images_mapped_args(
        self,
        ...
        ai_search: typing.Optional[bool] = None,
        ai_labels_limit: typing.Optional[int] = None,
        ai_industry: typing.Optional[str] = None,
        ai_objective: typing.Optional[str] = None,
        ...
        if ai_search is not None:
            _query_params["ai_search"] = ai_search
        if ai_labels_limit is not None:
            _query_params["ai_labels_limit"] = ai_labels_limit
        if ai_industry is not None:
            _query_params["ai_industry"] = ai_industry
        if ai_objective is not None:
            _query_params["ai_objective"] = ai_objective
    ...
    async def _asearch_images_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_ai_search,
            request_query_ai_labels_limit,
            request_query_ai_industry,
            request_query_ai_objective,
...
class SearchImagesRaw(BaseApi):
    ...
    async def asearch_images(
        ...
        **kwargs,
        ...
        args = self._search_images_mapped_args(
            ...
            ai_search=ai_search,
            ai_labels_limit=ai_labels_limit,
        ...
        return await self._asearch_images_oapg(
    ...
    def search_images(
        ...
        return self._search_images_oapg(
            query_params=args.query,
        )

class SearchImages(BaseApi):
    ...
    async def asearch_images(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ImageSearchResultsPydantic:
        raw_response = await self.raw.asearch_images(
            added_date=added_date,
            added_date_start=added_date_start,
            aspect_ratio_min=aspect_ratio_min,
            aspect_ratio_max=aspect_ratio_max,
        ...
        if validate:
            return ImageSearchResultsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ImageSearchResultsPydantic, raw_response.body)
    ...
    def search_images(
        ...
        raw_response = self.raw.search_images(
            added_date=added_date,
            added_date_start=added_date_start,
            aspect_ratio_min=aspect_ratio_min,
            aspect_ratio_max=aspect_ratio_max,
