...
from shutterstock_python_sdk.model.user_details import UserDetails as UserDetailsSchema

from shutterstock_python_sdk.type.user_details import UserDetails

from ...api_client import Dictionary
from shutterstock_python_sdk.pydantic.user_details import UserDetails as UserDetailsPydantic
...
SchemaFor200ResponseBodyApplicationJson = UserDetailsSchema
...
class GetUserDetails(BaseApi):
    ...
    async def aget_user_details(
        ...
        **kwargs,
        ...
        if validate:
            return UserDetailsPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserDetailsPydantic, raw_response.body)
