...
class RequiredLicenseSFXResult(TypedDict):
    # Sound effects ID that was licensed
    sfx_id: str

class OptionalLicenseSFXResult(TypedDict, total=False):
...
class LicenseSFXResult(RequiredLicenseSFXResult, OptionalLicenseSFXResult):
    pass
