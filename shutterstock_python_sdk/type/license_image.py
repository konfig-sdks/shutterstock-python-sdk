...
from shutterstock_python_sdk.type.custom_size_dimensions import CustomSizeDimensions
from shutterstock_python_sdk.type.license_request_metadata import LicenseRequestMetadata

class RequiredLicenseImage(TypedDict):
    # Image ID
    image_id: str

class OptionalLicenseImage(TypedDict, total=False):
    auth_cookie: Cookie
...
class LicenseImage(RequiredLicenseImage, OptionalLicenseImage):
    pass
